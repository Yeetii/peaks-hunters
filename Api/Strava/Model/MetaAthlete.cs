...
namespace Strava.Model
{
        ...
        public partial class MetaAthlete :  IEquatable<MetaAthlete>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as MetaAthlete);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(MetaAthlete input)
        {
            if (input == null)
                return false;
