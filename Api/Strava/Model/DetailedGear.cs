...
namespace Strava.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DetailedGear : SummaryGear,  IEquatable<DetailedGear>, IValidatableObject
    {
        /// <summary>
        ...
        public DetailedGear(string brandName = default(string), string modelName = default(string), int? frameType = default(int?), string description = default(string), string id = default(string), int? resourceState = default(int?), bool? primary = default(bool?), string name = default(string), float? distance = default(float?)) : base(id, resourceState, primary, name, distance)
        {
