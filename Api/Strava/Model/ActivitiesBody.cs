...
namespace Strava.Model
{
        ...
        public partial class ActivitiesBody :  IEquatable<ActivitiesBody>, IValidatableObject
    {
        ...
        public ActivitiesBody(string name = default(string), string type = default(string), string sportType = default(string), DateTime? startDateLocal = default(DateTime?), int? elapsedTime = default(int?), string description = default(string), float? distance = default(float?), int? trainer = default(int?), int? commute = default(int?))
        {
            ...
            // to ensure "sportType" is required (not null)
            if (sportType == null)
            {
                throw new InvalidDataException("sportType is a required property for ActivitiesBody and cannot be null");
            }
            else
            {
