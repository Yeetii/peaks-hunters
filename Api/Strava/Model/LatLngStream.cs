...
namespace Strava.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LatLngStream : BaseStream,  IEquatable<LatLngStream>, IValidatableObject
    {
        /// <summary>
        ...
        public LatLngStream(List<LatLng> data = default(List<LatLng>), int? originalSize = default(int?), ResolutionEnum? resolution = default(ResolutionEnum?), SeriesTypeEnum? seriesType = default(SeriesTypeEnum?)) : base(originalSize, resolution, seriesType)
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as LatLngStream);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(LatLngStream input)
        {
            if (input == null)
                return false;
