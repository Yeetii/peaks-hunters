...
namespace Strava.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TemperatureStream : BaseStream,  IEquatable<TemperatureStream>, IValidatableObject
    {
        /// <summary>
        ...
        public TemperatureStream(List<int?> data = default(List<int?>), int? originalSize = default(int?), ResolutionEnum? resolution = default(ResolutionEnum?), SeriesTypeEnum? seriesType = default(SeriesTypeEnum?)) : base(originalSize, resolution, seriesType)
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as TemperatureStream);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(TemperatureStream input)
        {
            if (input == null)
                return false;
