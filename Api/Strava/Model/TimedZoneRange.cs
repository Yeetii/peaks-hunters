...
namespace Strava.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TimedZoneRange : ZoneRange,  IEquatable<TimedZoneRange>, IValidatableObject
    {
        /// <summary>
        ...
        public TimedZoneRange(int? time = default(int?), int? min = default(int?), int? max = default(int?)) : base(min, max)
        {
            this.Time = time;
        }
