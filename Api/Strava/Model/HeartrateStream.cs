...
namespace Strava.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class HeartrateStream : BaseStream,  IEquatable<HeartrateStream>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HeartrateStream);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(HeartrateStream input)
        {
            if (input == null)
                return false;
