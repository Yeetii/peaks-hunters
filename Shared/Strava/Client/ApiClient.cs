...
namespace Strava.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Strava.Client.Configuration.Default;
            RestClient = new RestClient("https://www.strava.com/api/v3");
        }
        ...
        {
            Configuration = config ?? Strava.Client.Configuration.Default;
