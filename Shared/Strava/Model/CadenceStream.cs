...
namespace Strava.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CadenceStream : BaseStream,  IEquatable<CadenceStream>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CadenceStream" /> class.
        /// </summary>
        /// <param name="data">The sequence of cadence values for this stream, in rotations per minute.</param>
        public CadenceStream(List<int?> data = default(List<int?>), int? originalSize = default(int?), ResolutionEnum? resolution = default(ResolutionEnum?), SeriesTypeEnum? seriesType = default(SeriesTypeEnum?)) : base(originalSize, resolution, seriesType)
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as CadenceStream);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CadenceStream input)
        {
            if (input == null)
                return false;
